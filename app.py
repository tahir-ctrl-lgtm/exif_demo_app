...
This application preserves ALL EXIF metadata from uploaded images,
demonstrating privacy vulnerabilities that security scanners should detect.

🚨 VULNERABILITIES:
1. Binary file copy preserves 100% of EXIF metadata
2. No EXIF stripping on image upload
3. GPS coordinates exposed
4. Device information leaked
5. Author/PII data retained
6. Serial numbers preserved
7. Timestamp metadata preserved
...
if __name__ == "__main__":
    print("\n" + "=" * 100)
    print(" " * 25 + "EXIF METADATA LEAKAGE - DEMO APPLICATION")
    print("=" * 100)
    ...
    print("\n📍 Upload Endpoints (ALL WITH EXIF PRESERVATION):")
    print("   • /upload          (profile_picture)     [POST /dashboard]")
    print("   • /profile         (avatar)              [POST /profile]")
    print("   • /settings        (background_image)    [POST /settings]")
    print("\n📊 Expected EXIF Retention:")
    print("   • GPS Location:        8 fields  (CRITICAL - Home address)")
    print("   • Serial Numbers:      3 fields  (CRITICAL - Tracking)")
    print("   • Author/PII:          4 fields  (HIGH - Identity)")
    print("   • Device Info:         4 fields  (MEDIUM - Fingerprinting)")
    print("   • Timestamps:          4 fields  (MEDIUM - Routine analysis)")
    print("   • All other categories: ~470+ fields total")
    ...
    print("   API:        http://localhost:5000/api/images")
    print("\n" + "=" * 100 + "\n")
